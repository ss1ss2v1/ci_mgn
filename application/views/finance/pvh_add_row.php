...
<ul id="d_row_<?php echo $row; ?>" class="tb_row" style="border-bottom: 1px dotted black; ">
    ...
    <li class="tb_col">
        <div class="tb_col_unit" style="display: block;  border-left: 1px dotted gray;">
            <input maxlength="4" type="text" class="tb_col_unit" name="unit[<?php echo $row; ?>]" id="unit_<?php echo $row; ?>" value="" onfocus="unit_focus(<?php echo $row; ?>)" onchange="check_unit(<?php echo $row; ?>)" />
            ...
            <span class="field_info tb_col_unit" class="tb_col_unit" id="unit_name_<?php echo $row; ?>">Belum ditentukan</span>
        </div>
    </li>
    <li class="tb_col">
