...
<div id="container">
	<h1>View Voucher Penerimaan Kas/Bank</h1>
	<form id="frm_edit_rvh" method="POST" action="<?php echo base_url().'receipt_voucher/view'; ?>">
    <div id="entry_header">
        <ul>
    ...
    <ul class="tb_head">
            ...
            <li id="tb_head_RVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:35px;">No</li>
            <li id="tb_head_RVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:50px;">Referensi</li>
            <li id="tb_head_RVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:55px;">Rekening</li>
            <li id="tb_head_RVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:40px;">Unit</li>
            <li id="tb_head_RVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:50px;">Project</li>
            <li id="tb_head_RVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:60px;">Identitas</li>
            <li id="tb_head_RVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:70px;">Keterangan</li>
        ...
        <?php foreach ($rvds as $rvd) { ?>
                <ul id="d_row_" class="tb_row" style="border-bottom: 1px dotted black; ">
                    ...
                    <li class="tb_col" style="width:18px;"><?php echo $rvd['RVD_Nomor_Urut']  ?></li>
                    <li class="tb_col" style="width:55px;"><?php echo $rvd['RVD_Nomor_Referensi']  ?></li>
                    <li class="tb_col" style="width:70px;"><?php echo $rvd['RVD_Nomor_Rekening_Lawan']  ?></li>                   
                    <li class="tb_col" style="width:33px;"><?php echo $rvd['RVD_Unit_Code_Lawan']  ?></li>
                    <li class="tb_col" style="width:50px;"><?php echo $rvd['RVD_Project_Contract_Number_Lawan']  ?></li>
                    <li class="tb_col" style="width:55px;"><?php echo $rvd['RVD_Identitas_Lawan']  ?></li>
                    <li class="tb_col" style="width:90px;"><?php echo $rvd['RVD_Keterangan']  ?></li>
                    <li class="tb_col" style="width:50px;"><?php echo $rvd['RVD_Rupiah']  ?></li>
                </ul>
        <?php } ?>
...
<script>
    ...
    $("#RV_Kepada").change(function() { ai = $(this).val().split(' - '); $('#RV_Identitas').val(ai[0]); $('                     #RV_Nama_Identitas').val(ai[1]); });    
