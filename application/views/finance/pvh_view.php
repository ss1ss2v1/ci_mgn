...
<div id="container">
	<h1>View Voucher Pengeluaran Kas/Bank</h1>
	<form id="frm_edit_rvh" method="POST" action="<?php echo base_url().'payment_voucher/view'; ?>">
    <div id="entry_header">
        <ul>
            <li><label>Nomor Voucher:</label><span style="font-weight: bold;"><?php echo $pvh['PV_Nomor']; ?></span></li>
            <li><label>Tanggal:</label><?php echo $pvh['PV_Tanggal'];?></li>          
            <li><label>No Referensi:</label><?php echo $pvh['PV_Referensi'];?></li>
            <li><label>Dibayar kepada:</label><?php echo $pvh['PV_Kepada'];?></li>
            <li><label>Identitas (baru) :</label><?php echo $pvh ['PV_Identitas'];?></li>           
            <li><label>Untuk:</label><?php echo $pvh['PV_Keterangan'];?></li>            
            <li><label>Rekening:</label><?php echo $pvh ['PV_Account_Number'];?></li>
            <li><label>Kode Unit Usaha:</label><?php echo $pvh ['PV_Unit_Code'];?></li>
        </ul>
    </div>
    <div id="entry_detail">
    <ul class="tb_head">
            <li id="tb_head_spacer" class="tb_col_head" style="width:2px"></li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:35px;">No</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:50px;">Referensi</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:55px;">Rekening</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:40px;">Unit</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:50px;">Project</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:60px;">Identitas</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:70px;">Keterangan</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:75px;">Nominal</li>
        </ul>
        
        <?php foreach ($rvds as $rvd) { ?>
                <ul id="d_row_" class="tb_row" style="border-bottom: 1px dotted black; ">
                    <li class="tb_col" style="width:20px;"></li>
                    <li class="tb_col" style="width:18px;"><?php echo $rvd['PVD_Nomor_Urut']  ?></li>
                    <li class="tb_col" style="width:55px;"><?php echo $rvd['PVD_Nomor_Referensi']  ?></li>
                    <li class="tb_col" style="width:70px;"><?php echo $rvd['PVD_Nomor_Rekening_Lawan']  ?></li>                   
                    <li class="tb_col" style="width:33px;"><?php echo $rvd['PVD_Unit_Code_Lawan']  ?></li>
                    <li class="tb_col" style="width:50px;"><?php echo $rvd['PVD_Project_Contract_Number_Lawan']  ?></li>
                    <li class="tb_col" style="width:55px;"><?php echo $rvd['PVD_Identitas_Lawan']  ?></li>
                    <li class="tb_col" style="width:90px;"><?php echo $rvd['PVD_Keterangan']  ?></li>
                    <li class="tb_col" style="width:50px;"><?php echo $rvd['PVD_Rupiah']  ?></li>
                </ul>
        <?php } ?>
    ...
    <div style="margin-left:5px; margin-bottom:5px;">
        <input type="reset" value="OK!" name="Ok!" onclick="cancel_save();" />
    </div>
    </form>
