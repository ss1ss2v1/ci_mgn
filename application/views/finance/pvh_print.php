...
<div id="container">
	<h1>Print Voucher Pengeluaran Kas/Bank</h1>
	<form id="frm_edit_rvh" method="POST" action="<?php echo base_url().'payment_voucher/cetak'; ?>">
    <div id="entry_header">
        <ul>
    ...
    <ul class="tb_head">
            ...
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:48px;">No</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:60px;">Referensi</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:65px;">Rekening</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:35px;">Unit</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:60px;">Project</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:60px;">Identitas</li>
            <li id="tb_head_PVD_Nomor_Record" class="tb_col_head tb_col_nomor" style="width:78px;">Keterangan</li>
        ...
        <?php foreach ($rvds as $rvd) { ?>
                <ul id="d_row_" class="tb_row" style="border-bottom: 1px dotted black; ">
                    ...
                    <li class="tb_col" style="width:25px;"><?php echo $rvd['PVD_Nomor_Urut']  ?></li>
                    <li class="tb_col" style="width:65px;"><?php echo $rvd['PVD_Nomor_Referensi']  ?></li>
                    <li class="tb_col" style="width:65px;"><?php echo $rvd['PVD_Nomor_Rekening_Lawan']  ?></li>                   
                    <li class="tb_col" style="width:45px;"><?php echo $rvd['PVD_Unit_Code_Lawan']  ?></li>                    
                    <li class="tb_col" style="width:50px;"><?php echo $rvd['PVD_Project_Contract_Number_Lawan']  ?></li>
                    <li class="tb_col" style="width:65px;"><?php echo $rvd['PVD_Identitas_Lawan']  ?></li>
                    <li class="tb_col" style="width:90px;"><?php echo $rvd['PVD_Keterangan']  ?></li>
                    <li class="tb_col" style="width:65px;"><?php echo $rvd['PVD_Rupiah']  ?></li>
                </ul>
        <?php } ?>
    ...
    <div class="warning_box">Perhatian !! : Data pengeluaran ini bisa di cetak</div>      
</div>
<script>
    var nIndex=0; 
