...
<div id="container">
	<h1>Tambah Voucher Pengeluaran Kas/Bank</h1>
	<form id="frm_add_rvh" method="POST" action="<?php echo base_url().'payment_voucher/add_new'; ?>">
    <div id="entry_header">
        <ul>
            <li><label>Nomor Voucher:</label><input title="Isi dengan nomor voucher" type="text" name="PV_Nomor" id="PV_Nomor" maxlength="20" value="<?php echo set_value('PV_Nomor', '');?>" <?php echo (form_error('PV_Nomor')!=false) ? 'style="background:#f5c8c8"' : ''; ?> /></li>
            <?php if (form_error('PV_Nomor')!=false) { ?>
            <li><label></label><?php echo form_error('PV_Nomor', '<span class="err_text">', '</span>'); ?></li>
            <?php } ?>            
            <li><label>Tanggal:</label><input title="Isi dengan tanggal voucher" type="text" name="PV_Tanggal" id="PV_Tanggal" maxlength="10" value="<?php echo set_value('PV_Tanggal', '');?>" <?php echo (form_error('PV_Tanggal')!=false) ? 'style="background:#f5c8c8"' : ''; ?> /></li>
            <?php if (form_error('PV_Tanggal')!=false) { ?>
            <li><label></label><?php echo form_error('PV_Tanggal', '<span class="err_text">', '</span>'); ?></li>
            <?php } ?>            
            <li><label>No Referensi:</label><input title="Isi dengan nomor referensi (po/faktur/dll)" type="text" name="PV_Referensi" id="PV_Referensi" maxlength="20" value="<?php echo set_value('PV_Referensi', '');?>" /></li>
            ...
            <li>
                ...
                <input type="text" title="Isi dengan kode identitas objek akuntansi" name="PV_Identitas" id="PV_Identitas" maxlength="20" value="<?php echo set_value('PV_Identitas', '');?>" style="width:100px;<?php echo (form_error('PV_Identitas')!=false) ? 'background:#f5c8c8' : ''; ?>" />
                <input type="text" title="Isi dengan nama identitas objek akuntansi" name="PV_Nama_Identitas" id="PV_Nama_Identitas" maxlength="20" value="<?php echo set_value('PV_Nama_Identitas', '');?>" style="width:300px;<?php echo (form_error('PV_Nama_Identitas')!=false) ? 'background:#f5c8c8' : ''; ?>" />
            </li>
            <?php if (form_error('PV_Kepada')!=false) { ?>
            <li><label></label><?php echo form_error('PV_Kepada', '<span class="err_text">', '</span>'); ?></li>
            <?php } ?>            
            <li><label>Untuk:</label><input title="Isi dengan keterangan umum transaksi" type="text" name="PV_Keterangan" id="PV_Keterangan" maxlength="100" value="<?php echo set_value('PV_Keterangan', '');?>" style="width:300px;<?php echo (form_error('PV_Keterangan')!=false) ? 'background:#f5c8c8' : ''; ?>" /></li>
            <?php if (form_error('PV_Keterangan')!=false) { ?>
            <li><label></label><?php echo form_error('PV_Keterangan', '<span class="err_text">', '</span>'); ?></li>
            <?php } ?>            
            <li><label>Jenis Penerimaan:</label><select id="PV_Receipt_Type" name="PV_Receipt_Type" style="width:110px;"><option value="Kas">Kas</option><option value="Bank">Bank</option></select></li>
            <li><label>Rekening:</label><select id="PV_Account_Number" name="PV_Account_Number" style="width:350px;"><?php echo $account_list; ?></select></li>
            ...
            <li>
                ...
                <input type="text" title="Isi dengan nomor kontrak atau kosongkan jika transaksi bukan transaksi proyek" name="PV_Project_Contract_Number" id="PV_Project_Contract_Number" maxlength="20" value="<?php echo set_value('PV_Project_Contract_Number', '');?>" style="width:100px;<?php echo (form_error('PV_Project_Contract_Number')!=false) ? 'background:#f5c8c8' : ''; ?>" />
                <input type="text" title="Isi dengan keterangan kontrak atau kosongkan jika transaksi bukan transaksi proyek" name="PV_Project_Name" id="PV_Project_Name" maxlength="100" value="<?php echo set_value('PV_Project_Name', '');?>" style="width:300px;<?php echo (form_error('PV_Project_Name')!=false) ? 'background:#f5c8c8' : ''; ?>" />
            </li>
        </ul>
    </div>
    <div id="entry_detail">
                ...
                <ul id="d_row_<?php echo $i ?>" class="tb_row" style="border-bottom: 1px dotted black; ">
                    ...
                    <li class="tb_col">
                        <div class="tb_col_account" style="display: block; border-left: 1px dotted gray;">      
                            <input maxlength="15" type="text" class="tb_col_account" name="account[<?php echo $i ?>]" id="account_<?php echo $i ?>" value="<?php echo $account[$no]; ?>" onfocus="account_focus(<?php echo $i; ?>)" onchange="check_rekening(<?php echo $i ?>)" />
                    ...
                    <li class="tb_col">
                        <div class="tb_col_unit" style="display: block;  border-left: 1px dotted gray;">
                            <input maxlength="4" type="text" class="tb_col_unit" name="unit[<?php echo $i ?>]" id="unit_<?php echo $i ?>" value="<?php echo $unit[$no]; ?>" onfocus="unit_focus(<?php echo $i; ?>)" onchange="check_unit(<?php echo $i ?>)" />
                    ...
                    <li class="tb_col">
                        <div class="tb_col_project" style="display: block;  border-left: 1px dotted gray;">
                            <input maxlength="20" type="text" class="tb_col_project" name="project[<?php echo $i ?>]" id="project_<?php echo $i ?>" value="<?php echo $project[$no]; ?>" onfocus="project_focus(<?php echo $i; ?>)" onchange="check_project(<?php echo $i ?>)" />
                    ...
                    <li class="tb_col">
                        <div class="tb_col_identitas" style="display: block;  border-left: 1px dotted gray;">
                            <input maxlength="20" type="text" class="tb_col_identitas" name="identitas[<?php echo $i ?>]" id="identitas_<?php echo $i ?>" value="<?php echo $identitas[$no]; ?>" onfocus="identitas_focus(<?php echo $i; ?>)" onchange="check_identitas(<?php echo $i ?>)" />
