...
<div id="container">
	<h1>View Pelanggan Akun</h1>
    <form id="frm_trans_cs" method="POST" action="">
	<div id="entry_header">
        <form id="frm_trans_cs" method="POST" action="">
        <ul>
            <li><label>Nomor Pelanggan:</label><span style="font-weight: bold;"><?php echo $rvh['Customer_Kode']; ?></span></li>
    ...
    <div id="entry_detail">
     ...
     <ul class="tb_head">
            ...
            <li id="tb_head_Tanggal_Transaksi" class="tb_col_head tb_col_Tanggal_Transaksi" style="width:100px;">Kode Mata Uang</li>
            <li id="tb_head_Periode" class="tb_col_head tb_col_Periode" style="width:150px;">Rekening Kas Bank Penerima</li>
            <li id="tb_head_Jenis_Transaksi" class="tb_col_head tb_col_Jenis_Transaksi" style="width:100px;">Rekening Piutang</li>
            <li id="tb_head_Nilai_Transaksi_IDR" class="tb_col_head tb_col_Nilai_Transaksi_IDR" style="width:100px;">Rekening Deposit</li>
            <li id="tb_head_Kode_Referensi_1" class="tb_col_head tb_col_Kode_Referensi_1" style="width:120px;">Nama Bank Pembayar</li>
            <li id="tb_head_Kode_Referensi_2" class="tb_col_head tb_col_Kode_Referensi_2" style="width:120px;">Cabang Bank Pembayar </li>
            <li id="tb_head_Kode_Referensi_3" class="tb_col_head tb_col_Kode_Referensi_3" style="width:120px;">Alamat Bank Pembayar</li>
            <li id="tb_head_Unit_Code" class="tb_col_head tb_col_Unit_Code" style="width:150px;">Swift Code Bank Pembayar</li>
        </ul>
        
        <?php foreach ($rvds as $rvd) { ?>
                <ul id="d_row_" class="tb_row" style="border-bottom: 1px dotted black; ">
                    <li class="tb_col" style="width:2px;"></li>
                    <li class="tb_col" style="width:100px;"><?php echo $rvd['Kode_Mata_Uang']  ?></li>
                    <li class="tb_col" style="width:150px;"><?php echo $rvd['Rekening_Kas_Bank_Penerima']  ?></li>
                    <li class="tb_col" style="width:100px;"><?php echo $rvd['Rekening_Piutang']  ?></li>
                    <li class="tb_col" style="width:100px;"><?php echo $rvd['Rekening_Deposit']  ?></li> 
                    <li class="tb_col" style="width:120px;"><?php echo $rvd['Nama_Bank_Pembayar']  ?></li> 
                    <li class="tb_col" style="width:120px;"><?php echo $rvd['Cabang_Bank_Pembayar']  ?></li> 
                    <li class="tb_col" style="width:120px;"><?php echo $rvd['Alamat_Bank_Pembayar']  ?></li> 
                    <li class="tb_col" style="width:150px;"><?php echo $rvd['Swift_Code_Bank_Pembayar']  ?></li>                    
                </ul>               
                <?php } ?>
