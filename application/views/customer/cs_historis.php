...
<div id="container">
    ...
    <div id="entry_detail">
     ...
     <ul class="tb_head">
            ...
            <li id="tb_head_Tanggal_Transaksi" class="tb_col_head tb_col_Tanggal_Transaksi" style="width:90px;">Periode</li>
            <li id="tb_head_Periode" class="tb_col_head tb_col_Periode" style="width:90px;">Kode Mata Uang</li>
            <li id="tb_head_Jenis_Transaksi" class="tb_col_head tb_col_Jenis_Transaksi" style="width:90px;">Saldo Awal</li>
            <li id="tb_head_Nilai_Transaksi_IDR" class="tb_col_head tb_col_Nilai_Transaksi_IDR" style="width:150px;">Pembayaran Deposit</li>
            <li id="tb_head_Kode_Referensi_1" class="tb_col_head tb_col_Kode_Referensi_1" style="width:90px;">Penjualan</li>
            <li id="tb_head_Kode_Referensi_2" class="tb_col_head tb_col_Kode_Referensi_2" style="width:90px;">Nota Debet </li>
            <li id="tb_head_Kode_Referensi_3" class="tb_col_head tb_col_Kode_Referensi_3" style="width:90px;">Nota Kredit</li>
            <li id="tb_head_Unit_Code" class="tb_col_head tb_col_Unit_Code" style="width:90px;">Pembayaran</li>
        </ul>
        
        <?php foreach ($rvds as $rvd) { ?>
                <ul id="d_row_" class="tb_row" style="border-bottom: 1px dotted black; ">
                    <li class="tb_col" style="width:2px;"></li>
                    <li class="tb_col" style="width:90px;"><?php echo$rvd['Periode']  ?></li>
                    <li class="tb_col" style="width:90px;"><?php echo $rvd['Kode_Mata_Uang']  ?></li>
                    <li class="tb_col" style="width:90px;"><?php echo $rvd['Saldo_Awal']  ?></li>
                    <li class="tb_col" style="width:150px;"><?php echo $rvd['Pembayaran_Deposit']  ?></li> 
                    <li class="tb_col" style="width:90px;"><?php echo $rvd['Penjualan']  ?></li> 
                    <li class="tb_col" style="width:90px;"><?php echo $rvd['Nota_Debet']  ?></li> 
                    <li class="tb_col" style="width:90px;"><?php echo $rvd['Nota_Kredit']  ?></li> 
                    <li class="tb_col" style="width:90px;"><?php echo $rvd['Pembayaran']  ?></li>                    
                </ul>               
                <?php } ?>
